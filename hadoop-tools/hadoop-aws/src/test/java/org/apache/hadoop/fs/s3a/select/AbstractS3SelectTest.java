...
public abstract class AbstractS3SelectTest extends AbstractS3ATestBase {
  ...
  protected TaskAttemptContext createTaskAttemptContext(final JobConf conf)
      throws Exception {
    String jobId = AbstractCommitITest.randomJobId();
    String attempt0 = "attempt_" + jobId + "_m_000000_0";
    TaskAttemptID taskAttempt0 = TaskAttemptID.forName(attempt0);

    return new TaskAttemptContextImpl(conf, taskAttempt0);
  }
