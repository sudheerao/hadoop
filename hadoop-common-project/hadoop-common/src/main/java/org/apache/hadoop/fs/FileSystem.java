...
public abstract class FileSystem extends Configured implements Closeable {
 ...
 /**
   ...
   * {@link FSDataInputStreamBuilder#build()} in which the open operation
   ...
   * {@link FSDataInputStreamBuilder#build()} command,
   ...
   *
   * This is invoked from {@link FSDataInputStreamBuilder#build()}
